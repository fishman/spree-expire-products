...
desc 'Generate documentation for the expire_products extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ExpireProductsExtension'
...
desc 'Test the expire_products extension.'
...
namespace :test do
  desc 'Functional test the expire_products extension.'
  ...
  desc 'Unit test the expire_products extension.'
